...
<div class="mt-6">
    ...
    <a href="/auth/github" class="flex items-center justify-center bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded transition duration-300 ease-in-out transform hover:scale-105">
    ...
    <a href="/auth/google" class="flex items-center justify-center bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded transition duration-300 ease-in-out transform hover:scale-105">
